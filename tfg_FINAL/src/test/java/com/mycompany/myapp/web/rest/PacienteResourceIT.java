...
public class PacienteResourceIT {
    ...
    private static final Integer DEFAULT_NHC = 1;
    private static final Integer UPDATED_NHC = 2;
    ...
    private static final NivelEstudios DEFAULT_ESTUDIOS = NivelEstudios.ILETRADO;
    private static final NivelEstudios UPDATED_ESTUDIOS = NivelEstudios.LEER_Y_ESCRIBIR;
    ...
    public void createPaciente() throws Exception {
        ...
        assertThat(testPaciente.getNhc()).isEqualTo(DEFAULT_NHC);
    ...
    @Test
    @Transactional
    public void checkNhcIsRequired() throws Exception {
        int databaseSizeBeforeTest = pacienteRepository.findAll().size();
        // set the field null
        paciente.setNhc(null);
    ...
    public void getAllPacientes() throws Exception {
        ...
        restPacienteMockMvc.perform(get("/api/pacientes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nhc").value(hasItem(DEFAULT_NHC)))
    ...
    public void getPaciente() throws Exception {
        ...
        restPacienteMockMvc.perform(get("/api/pacientes/{id}", paciente.getId()))
            ...
            .andExpect(jsonPath("$.nhc").value(DEFAULT_NHC))
    ...
    public void updatePaciente() throws Exception {
        ...
        Paciente testPaciente = pacienteList.get(pacienteList.size() - 1);
        assertThat(testPaciente.getNhc()).isEqualTo(UPDATED_NHC);
