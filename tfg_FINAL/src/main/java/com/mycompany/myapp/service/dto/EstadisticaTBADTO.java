...
/**
 * A DTO for the {@link com.mycompany.myapp.domain.EstadisticaTBA} entity.
 */
public class EstadisticaTBADTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        EstadisticaTBADTO estadisticaTBADTO = (EstadisticaTBADTO) o;
        if (estadisticaTBADTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), estadisticaTBADTO.getId());
    }
