...
/**
 * A DTO for the {@link com.mycompany.myapp.domain.EstadisticaFAB} entity.
 */
public class EstadisticaFABDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        EstadisticaFABDTO estadisticaFABDTO = (EstadisticaFABDTO) o;
        if (estadisticaFABDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), estadisticaFABDTO.getId());
    }
