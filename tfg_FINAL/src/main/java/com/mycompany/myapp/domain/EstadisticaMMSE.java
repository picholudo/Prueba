 ...
 */
@Entity
@Table(name = "estadistica_mmse")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class EstadisticaMMSE implements Serializable {
    ...
    @NotNull
    @JsonIgnoreProperties("estadisticaMMSES")
    ...
    public EstadisticaMMSE media(Float media) {
        this.media = media;
        return this;
    }
    ...
    public EstadisticaMMSE desviacionTipica(Float desviacionTipica) {
    ...
    public EstadisticaMMSE codigoEstudio(CodigoEstudio codigoEstudio) {
    ...
    public EstadisticaMMSE edadTipoPrueba(EdadTipoPrueba edadTipoPrueba) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EstadisticaMMSE)) {
            return false;
        }
        return id != null && id.equals(((EstadisticaMMSE) o).id);
    }
